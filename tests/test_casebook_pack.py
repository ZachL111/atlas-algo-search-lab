"""Regression checks for the atlas-algo-search-lab casebook."""
...
from casebook.harness import assert_expected, atlas_algo_search_lab_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(atlas_algo_search_lab_summary(), assert_expected())
