...
`atlas-algo-search-lab` is centered on algorithms work in OCaml. The technical target is: Package an OCaml local lab for search analysis with safe and unsafe fixtures, remediation hints, and documented operating limits.
...
The score is deterministic. The current threshold is 172. Risk has a penalty of 4, latency has a penalty of 2, and weight contributes a bonus of 2.
